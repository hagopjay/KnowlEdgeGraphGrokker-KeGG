#!/usr/bin/env bash
# killports-wsl.sh — Nuke stray dev server processes on WSL/Linux
# Usage: ./killports-wsl.sh          (kill all common dev ports)
#        ./killports-wsl.sh 3000     (kill specific port)
#        ./killports-wsl.sh 3000 8080 5173  (kill multiple)
